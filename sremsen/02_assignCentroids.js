function run(){
    // starting with means that we've chosen
...
function assignCentroids(means) {
    ...
    data.forEach(function(point){
        // looping through the points, then looping through the centroids
        // to see which one is closest to each centroid
        ...
        // find the index position of that array
